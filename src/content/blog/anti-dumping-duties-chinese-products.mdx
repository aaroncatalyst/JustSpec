...
Anti-dumping duties (ADD) and countervailing duties (CVD) are the most dangerous blind spot in the China import tariff picture. They're separate from Section 301 and the emergency/reciprocal tariffs, they apply at the product level rather than the broad category level, and they can be enormous — 50%, 100%, 200%, sometimes higher. Importers who correctly calculate MFN + Section 301 + any current surcharge and then get hit with an AD/CVD order they didn't know existed discover very quickly that their product is no longer importable at any workable margin.
...
## ADD/CVD vs Section 301 vs the Emergency Tariffs — The Full Stack
...
- Emergency/reciprocal surcharge: variable and in legal flux (IEEPA struck down; Section 122 replacement litigated — verify current)
