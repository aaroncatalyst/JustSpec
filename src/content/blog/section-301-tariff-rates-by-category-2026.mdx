...
The current combined tariff exposure on a Chinese product is: MFN rate + applicable Section 301 rate + any IEEPA rate + any AD/CVD rate. The Section 301 rate is one layer of several — see our [China tariffs overview](/blog/china-tariffs-2026-importers-guide) for how the full stack works.
