...
description: "T/T, L/C, D/P, O/A — supplier payment terms decide who carries the risk between deposit and delivery. A plain-English guide to what each means, the deposit split that protects you, and when to use each."
...
## Currency, Fees, and the Small Print

A few practicalities that quietly affect the real cost of a payment:

- **Currency.** Most China trade is quoted and paid in USD. If a supplier quotes in RMB, understand who carries the exchange risk and whether the rate moves the price.
- **Wire fees.** International wires carry sending and intermediary-bank fees ($15–50+ each). On staged payments that's multiple fees per order — small, but real, and worth knowing.
- **Who pays what.** Confirm the supplier receives the full invoice amount net of fees, or you'll get a "short payment" query that delays production over $30.
- **Get it in writing.** The deposit split, the inspection condition, and the banking details belong in the PI (proforma invoice) or agreement, not just a chat message.
