...
Important: the 51.4% rate in this example is specific to HTS 3924.10 and the current IEEPA rate. Your product's combined rate could be materially different — 30% for some categories, 80%+ for products with AD/CVD on top. [Check your actual rate](https://lgistics.ai).
